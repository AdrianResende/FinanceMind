  ...
  <div class="hero-bg">
    <v-container class="py-16 text-center">
      <v-responsive class="mx-auto" max-width="720">
        <v-chip color="secondary" variant="tonal" size="small" class="mb-4 font-weight-medium">
          Beta gratuito
        </v-chip>
...
.hero-bg {
  background:
    radial-gradient(circle at 50% 0%, rgba(14, 156, 143, 0.12), transparent 55%),
    radial-gradient(circle at 85% 15%, rgba(15, 76, 100, 0.08), transparent 50%);
}
</style>
